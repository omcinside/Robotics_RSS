...
int AttachHandler(CPhidgetHandle Analog, void *userptr)
{
	int serialNo;
	const char *name;
...
int DetachHandler(CPhidgetHandle Analog, void *userptr)
{
	int serialNo;
	const char *name;
...
int ErrorHandler(CPhidgetHandle Analog, void *userptr, int ErrorCode, const char *unknown)
{
