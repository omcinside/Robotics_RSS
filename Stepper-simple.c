...
int AttachHandler(CPhidgetHandle stepper, void *userptr)
{
	int serialNo;
	const char *name;
...
int DetachHandler(CPhidgetHandle stepper, void *userptr)
{
	int serialNo;
	const char *name;
...
int ErrorHandler(CPhidgetHandle stepper, void *userptr, int ErrorCode, const char *Description)
{
	printf("Error handled. %d - %s\n", ErrorCode, Description);
	return 0;
}

int PositionChangeHandler(CPhidgetStepperHandle stepper, void *usrptr, int Index, __int64 Value)
{
