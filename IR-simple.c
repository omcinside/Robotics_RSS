...
int AttachHandler(CPhidgetHandle ir, void *userptr)
{
	int serialNo;
...
int DetachHandler(CPhidgetHandle ir, void *userptr)
{
	int serialNo;
	CPhidget_getSerialNumber(ir, &serialNo);
...
int ErrorHandler(CPhidgetHandle ir, void *userptr, int ErrorCode, const char *unknown)
{
	printf("Error handled. %d - %s \n", ErrorCode, unknown);
	return 0;
}

int CodeHandler(CPhidgetIRHandle ir, void *userPtr, unsigned char *data, int dataLength, int bitCount, int repeat)
{
	int i;
...
int LearnHandler(CPhidgetIRHandle phid, void *userPtr, unsigned char *data, int dataLength, CPhidgetIR_CodeInfoHandle codeInfo)
{
	int i;
	printf("Learned Code: ");
	for(i = 0; i < dataLength; i++)
...
int RawDataHandler(CPhidgetIRHandle phid, void *userPtr, int *data, int dataLength)
{
	int i;
	printf("----------------------------------------------------\n");
	for(i = 0; i < dataLength; i++)
